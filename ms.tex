...
The JWST attitude control system team provided a simulation of the expected pointing performance shown in Figure \ref{fig:tserPointing}.
...
\caption{The very precise pointing expected by JWST will produce very small flux variations on the crosshatch pattern with an expected standard deviation of only 7 ppm.
}\label{fig:tserPointing}
\end{figure*}
