...
Optimistically, 30 transits may be enough to detect O$_3$ in the atmosphere of TRAPPIST-1 d with JWST if clouds have a minimal impact on its atmosphere \citep{barstow2016trappist1habitable}.
...
The schematic in Figure \ref{fig:npSchematic} instead shows the mobile charge carriers as ``+'' and ``-'' because it is easier to understand the charge trapping effect this way \citep[e.g.][]{smith2008imgPersistence}.
