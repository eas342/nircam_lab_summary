...
Here, we provide estimates of the noise source affecting JWST NIRCam time series.
...
\subsection{Reference Channel Subtraction}
...
\subsection{Optimally Co-Variance Weighted Flux}\label{sec:optimalCovWeights}
...
\subsection{Empirical Covariance Matrix}\label{sec:empCovarianceMatrix}
...
\subsection{Impact to Grism Time series}
