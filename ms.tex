...
By putting together 30 transits, it may be possible to collect enough photons to detect CO$_2$ and possibly O$_3$ in the atmosphere of TRAPPIST-1 d with JWST \citep{barstow2016trappist1habitable} if clouds have a minimal impact to its atmosphere.
...
\section{Pre-amp Resets}
The NIRCam detectors' pre-amps are reset once per frame (as opposed to once per integration) to prevent large amplifier drifts over an integration \citep{robberto2014refPixPreAmp}
