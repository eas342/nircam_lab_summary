...
The central peak is used for centroiding the 70 pixel radius circular aperture.}\label{fig:WLP8PSF}
\end{figure}
...
The WLP8SUB (subarray) showed the smallest standard deviation of any NIRCam mode explored.}\label{fig:CV3longTser}
\end{figure}
