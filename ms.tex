...
We exclude reference pixels (which form a 4 pixel wide boundary around the detector) and an additional row on the bottom and top fo the array because these illuminated rows are anomalous.
