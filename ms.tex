...
\includegraphics[width=.5\columnwidth]{fullframe_background_sub_compare.pdf}
\caption{{\it Top:} A variety of subarrays in the OTIS stability tests were read out with similar integration times (32 to 39 seconds) to compare relative precision of the read modes. 
