...
These long dark integrations are used to create simulated time series because there is less available time series data with dark frames.
...
The most important step in reducing the noise is the 1/f removed by side reference pixels. 
