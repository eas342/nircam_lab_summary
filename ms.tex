...
\fig{individual_azlab06_sub320_multi_exp_w_time}{0.48\textwidth}{Multi-Exposure Time series with temperature data}
...
As with previous tests, the standard deviation is well above the photon and read noise value and furthermore doesn't scale with the $\sqrt{N}$ for $N$ points in a bin.
