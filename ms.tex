...
\begin{itemize}[noitemsep]
	...
	Crosshatching patterns on HgCdTe detectors (which all JWST near-infrared instruments use) have been measured to extend to the sub-pixel level  \citep{shapiro2018crosshatch,ninan2019crosshatchHPF}
