...
We were investigated best practices for the pipeline and analysis by running the raw data through the pipeline and changing the steps to produce light curve.
...
In Figure \ref{fig:CV3pipeParamsWLP8} we show the standard deviation of the flux after averaging the A1 and B4 detectors and dividing by a linear fit to remove long-term trends for two example tests SUBThe IPC correction and 
