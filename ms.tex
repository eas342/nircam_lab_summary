...
(\textbf{Why does the literature \citep{rieke2007irDetectorReview,zhou2017chargeTrap} refer to the current, as opposed to the voltage? I thought you measure a voltage and then reset? Is this the gate voltage?})
...
The mechanism proposed to explain persistence is that charges are trapped in the depletion region and are released at later times \citep{smith2008imgPersistence} 
