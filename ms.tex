...
We also describe a covariance weighting scheme that can significantly lower the contributions from 1/f noise.
...
We use Equation \ref{eq:covarianceweights}, to further beat down the read noise.
