...
\begin{equation}
f(k_{x,i}',k_{y,i}', a_i, b,c) = a \exp{\left(- |k_{x,i}'| / b \right)} \left( \frac{1}{(0.5 c)^2 + k_y'^2} \right),
\end{equation}
where $k_x'$ and $k_y'$ are rotated frequency coordinates coordinates, $a$ is the amplitude, $b$ is the parallel exponential constant and $c$ is the Lorenzian full width at half maximum.
