...
We therefore conclude that the crosshatch pattern is mostly likely related to the crystal lattice of the HgCdTe substrate and not the pixels or circuitry.

The crosshatch structure of the detectors extends down to the subpixel level, so it may not be fully corrected with a flat field division.
This sub-pixel structure has been imaged with microscopy \citep{shapiro2018crosshatch}.
