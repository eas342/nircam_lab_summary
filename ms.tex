...
During the Cyrogenic Vacuum Test 3, the Integrated Science Instrument Module (ISIM) was placed in a vacuum chamber with a simulated telescope to illuminate the detectors in a similar way as during flight with an instrument called the Optical telescope element simulator (OSIM).
Of all ground-based tests discussed in this work, the point spread function most closely resembled the JWST flight point spread function.
...
As with the spatial scanning mode on HST \citep[e.g.][]{mccullough2012spatialScan,demin13}, spreading the light of a source over many pixels can improve the precision of spectroscopy.
...
By spreading the light source over many pixels, the light curve becomes less sensitive to flat fielding or intra-pixel sensitivity errors with the jitter or seeing variations during an observation.
