...
Experience with the Hubble Space Telescope (HST), \spitzer, and \kepler\ shows that there many potential systematics that can affect high precision time series and prevent photon-limited performance unless corrected for \citep[e.g.][]{beichman2014pasp}.
...
\subsection{Known Detector Effects}
