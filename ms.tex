...
\end{equation}
where Var() is the variance or the expectation of the deviation from the mean and $V_j =$Var$(S_j$) \citep{horne1986optimalE}.
...
The optimal weights for correlated data are \citep{schmelling1995averagingCorrelatedData} the sum of the inverse covariance matrix,
