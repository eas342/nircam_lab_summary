...
If we assume each pixel's read noise is uncorrelated with its neighbors, the total noise within the source aperture is then $\sqrt{N_{px}}$ where $N_{px} RN$ is the number of pixels and $RN$ is the read noise of a single pixel.
