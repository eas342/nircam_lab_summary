...
\begin{figure*}
%\gridline{\fig{tser_LW_OTIS.pdf}{0.99\textwidth}{WLP8 Image} }
\gridline{\fig{o9LEDwFlat_dyn_spec_NRCN83-256-O9LW.pdf}{0.55\textwidth}{Dynamic Spectrum}
\fig{o9LEDwFlat_bb_series_NRCN83-256-O9LW.pdf}{0.44\textwidth}{Broadband Time Series}}
%\gridline{\fig{o9LEDwFlat_ind_spec_NRCN83-256-O9LW.pdf}{0.44\textwidth}{Representative Spectrum}
%}
\caption{The dynamic spectrum of the grism along shows large artifacts due to motion of the source (broad horizontal stripes), that also show up in the integrated broadband time series.
The effect of image motion along the dispersion direction is visible as broad stripes
}\label{fig:otisLWdynSpec}
\end{figure*}

We also analyze the spectroscopic time series for the OTIS grism time series.
The extracted spectrum and dynamic spectrum (how it varies in time) can be seen in Figure \ref{fig:otisLWdynSpec}.
...
The crosshatch pattern is also 
The offset between the spectra are likely due to the non-linearity corrections applied to the flat fielded data.
...
\begin{figure*}
\gridline{\fig{spec_offsets_o9LEDwf322w2Flat_NRCN83-256-O9LW.pdf}{0.49\textwidth}{}}
\caption{The position variations along the dispersion direction for this time series test are two orders of magnitude larger than expectation for flight.
}\label{fig:otisWavebinTSeries}
\end{figure*}
