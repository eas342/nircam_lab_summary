...
As with the spatial scanning mode on HST \citep[e.g.][]{}, spreading the light of a source over many pixels can improve the precision


NIRCam instrument was 
 package (was lowered into 

Figure \ref{fig:WLP8PSF} show the PSF of the +8 wave defocused images used the Crogenic Vacuum 3 (CV3) stability tests.
