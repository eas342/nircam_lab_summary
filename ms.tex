...
When NFF=2048, there is no long a pattern and each integration is consistent.
...
\textbf{\textcolor{red}{Show exposure boundaries}}
...
There are no obvious transients or exponentials at the exposure boundaries.
As with previous tests, the standard deviation is well above the photon and read noise value and furthermore doesn't scale with the $\sqrt{N}$ for $N$ points in a bin.}\label{fig:AZlab06LongMultiExp}
\end{figure*}
