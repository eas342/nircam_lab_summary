...
These three angles are similar to one possible projection of a tetrahedral (zincblende) lattice structure of HgCdTe (bottom).
}\label{fig:crossHatchA5}
\end{figure}

The crosshatch pattern is wavelength dependent.
...
\begin{itemize}
	...
	\item Low frequency ($<$ 1/10second) jitter the simulated PSF over with a 6 mas Gaussian
