...
We use a robust mean row-by-row subtraction for a background annulus from 95 to 190 pixels and this reduces the measured read noise on a dark (un-illuminated) region to 60 to 100 ppm.
