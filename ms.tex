...
\begin{figure*}[!hbtp]
\centering
\includegraphics[width=.4\columnwidth]{pixeltime_series_amp_0_full_fft_cleaned_True.pdf}
\caption{The discreet Fourier transform of the entire time series from one amplifier shows 1/f noise at low frequencies that levels off at high frequencies.
}\label{fig:pixelTSeriesFFT}
\end{figure*}
