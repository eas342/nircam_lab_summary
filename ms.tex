...
\includegraphics[width=0.99\columnwidth]{subg_pos_grism64flat.pdf}\\
\vspace{0.2in}
...
\includegraphics[width=0.99\columnwidth]{subg_pos_grism64_psd.pdf}\\
\caption{
The top of the array has the smallest level of crosshatching and the middle has the largest.
This is visible in the flat field images (top three panels) and their power spectral density functions (bottom three panels) for three different sections of the A5 detector: a theoretical ``aperture'' position at the top of the array, the full frame position near Y=512 and the nominal SUBGRISM64 at the bottom of the array.
 }\label{fig:subpixScanSimulation}
\end{figure}
