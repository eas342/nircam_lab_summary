...
If uncorrected, this extra read noise will contribution 7000 ppm to the time series!
As can be seen in Figure \ref{fig:longDarkPhot}, there a significant correlations along the fast read (X) direction of the detector due to 1/f noise.
These can be reduced with the side reference pixels as well as a median of the entire image along the X direction.
...
\textcolor{red}{To do}
\begin{itemize}
	\item Confirm that the side reference pixels are most critical in reducing the noise
\end{itemize}
