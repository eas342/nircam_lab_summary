...
As the number of reads up the ramp becomes larger and large, the standard deviation increases.

\begin{figure}[!hbtp]
\centering
\includegraphics[width=.99\columnwidth]{subarray_config_tser.pdf}
