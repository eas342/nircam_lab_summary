...
\begin{itemize}
	...
	\item An annulus aperture on the source usually gives the best precision light curves
\end{itemize}
...
There are also some lessons learned from CV3 tests on which corrections have small effects on the final measured precision.
