...
The detectors are illuminated by short wavelength LEDs (1.6 to 1.8~$\mu$m) or long wavelength (\textbf{Which type and wavelength?}) LEDs.
The LEDS are type Lms17 and ???? from Electro Optical Components, Inc.
...
If no background subtraction is done, paradoxically, the tallest subgrism (fewest groups) is the most stable. \textbf{\textcolor{red}{How does this make sense? Did I possibly change how the side reference pix correction was done between the 3 tests? Changed from the FFT-based method to savgol on Fri Jul 12 22:04:54 2019. Processed the files on Jul 10 18:06. Could this be important? I will try and experiment on darks as well as re-processing the original baseline data to see.} }}\label{fig:subarraySizes}
\end{figure*}
