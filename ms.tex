...
\begin{figure*}
\gridline{
\fig{illum_slope_and_intercept.pdf}{0.49\textwidth}{Illumination Gradient Change over Time}
}
\caption{The illumination gradient changes as a function of time for the AZlab06 baseline test detector 487..}\label{fig:illumGradientChangeOverTime}
\end{figure*}
