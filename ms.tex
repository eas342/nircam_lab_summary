...
Figure \ref{fig:pixelTSeriesPSpec} shows the average Lomb Scargle periodogram from the middle left amplifier (512-1023 px) over 108 dark frames.
...
It is instructive to look at dark frames to isolate the contributions of the read-out electronics, including the side-car SIDECAR ASIC, and how much they contribute to the error budget.
