...
\begin{figure*}
\gridline{\fig{azlab06_illum_baseline_plot_region_488.pdf}{0.49\textwidth}{Region over which the pixels are averaged and plotted}
\fig{azlab06_illum_baseline_plot_region_490.pdf}{0.49\textwidth}{Region over which the pixels are averaged and plotted}}
\gridline{\fig{azlab06_illum_baseline_slope_flat_fielded_profile_plot_488.pdf}{0.49\textwidth}{Flat-fielded count rates during the early and late parts of the baseline test (488)}
