...
{\it: Left:} The time series constructed from raw dark frames.
{\it Right:} The time series with gain, bias, reference, non-linearity and IPC correction applied. }\label{fig:longDarkPhot}
\end{figure*}
