...
\begin{figure*}[!hbtp]
\centering
\includegraphics[width=.4\columnwidth]{pixeltime_series_0.pdf}
\includegraphics[width=.4\columnwidth]{pixeltime_series_1.pdf}
\caption{The time series for all 4 amplifiers share common-mode behaviors in some cases (left) but not always (right).
...
The right panel shows another part of the time series where Amplifier 3 has its own individual correlated-noise pattern.
