...
\end{equation}
where $x'$ and $y'$ are rotated coordinates, $a$ is the amplitude, $b$ is the parallel exponential constant and $c$ is the Lorenzian width.
...
We only fit the region of the power spectral density above r=100 to focus on the high frequency component of the flat field where the crosshatch is most prevalnt.
We find 
for $\theta_i = 0.9\degree$, 68.6$\degree$ and 113.1$\degree$.
