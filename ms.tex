...
\tablecaption{Summary of Noise Sources in OTIS Dark Test}\label{tab:noiseSummary1overf}
\tabletypesize{\footnotesize}
%\tablecolumns{7}
%\tablenum{2}
\tablewidth{0pt}
...
When reference pixel corrections are applied to the data and a 70 pixel source radius is used, the measured CDS read noise from the dark test is 280 ppm.
Since the full frame imaging had 2 samples (2 groups in RAPID mode), the read noise should be 280 ppm.
The WLP8SUB integrations had 20 groups, so the measured read noise should be 280 ppm $\sqrt{2/20}$ or 89 ppm.
So, read noise differences can account for 200 ppm differences between the two modes.
\textcolor{red}{\bf Continue HERE!}
