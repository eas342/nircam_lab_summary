...
\caption{Source apertures (labeled ``0'') and horizontally-displaced background apertures for the AZLab 06 $320 \times 320$ subarray test.}\label{fig:sub320AperturesAZlab06}
\end{figure*}
...
\caption{The time series of the AZLab 06 $320 \times 320$ subarray shows considerably higher scatter than the stripe mode.}\label{fig:sub320vsStripeBaseline2}
\end{figure*}
