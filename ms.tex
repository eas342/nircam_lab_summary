...
This spurious signal (the shrinking of the depletion region as highlighted with red circles), causes a voltage change in future integrations that appears the same as a true signal from incoming photons.}\label{fig:npSchematic}
\end{figure}
...
Figure \ref{fig:npSchematic} shows how the size of the depletion region changes after charges have been released, highlighted with red circles.
