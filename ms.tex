...
We give some illustrative numbers for a 0.17 $\mu$m wide bin of a grism spectrum as shown in Figure \ref{tab:noiseSummary1overf}.
Without reference pixel subtraction, the grism apertures have standard deviations of 81,200 DN.
Reference pixel subtraction drops this value to 12,900 DN and row-by-row subtraction drops it to 7,120 DN.
For a well depth of 60\%, there are $4.2 \times 10^6$ DN of source counts in the 0.17 $\mu$m bin, which amounts to a photon error of 7,400 DN assuming a gain of 1.84.
